...
import { ResponsiveContainer } from "@/components/ui/enhanced/responsive-container"
    ...
    <div className="space-y-lg">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-md">
        <div>
          ...
          <p className="text-body-sm text-muted-foreground">Manage your financial accounts and track balances</p>
        </div>
