        ...
        <div className="text-center space-y-8 py-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <div className="text-sm text-muted-foreground">Fullstack Framework</div>
            </div>
            <div className="space-y-2">
              <div className="text-2xl font-bold text-green-500">React 19</div>
              <div className="text-sm text-muted-foreground">UI Library</div>
            </div>
            <div className="space-y-2">
              <div className="text-2xl font-bold text-green-500">Prisma ORM</div>
              <div className="text-sm text-muted-foreground">Database Client</div>
            </div>
            <div className="space-y-2">
              <div className="text-2xl font-bold text-green-500">Clerk Auth</div>
              <div className="text-sm text-muted-foreground">Authentication</div>
            </div>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto pt-4">
            <div className="space-y-2">
              <div className="text-2xl font-bold text-green-500">PostgreSQL</div>
              <div className="text-sm text-muted-foreground">Database</div>
            </div>
            <div className="space-y-2">
              <div className="text-2xl font-bold text-green-500">Redis</div>
              <div className="text-sm text-muted-foreground">Caching Layer</div>
            </div>
            <div className="space-y-2">
              <div className="text-2xl font-bold text-green-500">TanStack Query</div>
